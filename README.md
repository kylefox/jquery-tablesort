...
Currently, numbers pulled from a cell's `$.text()` return value would be evaluated as strings (ie 11 < 1). To fix this, number strings are converted to numbers using `parseFloat()`.
